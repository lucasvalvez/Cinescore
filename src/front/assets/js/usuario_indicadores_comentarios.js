...
async function carregarFavoritos() {
  ...
  if (localStorage.getItem("emailUsuario") != null) {
    ...
    const responseTitulosMaisComentados = await fetch(`http://localhost:8080/api/feedback/titulosMaisComentados`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
    ...
    const responsePorcentagem = await fetch(`http://localhost:8080/api/feedback/indicadorComentario`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
